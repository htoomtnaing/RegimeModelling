...
# `src/regime_taa.py`, and writes every result to `./outputs/HMM/`. It does four things.
# 
...
# 
# **Outputs written to `./outputs/HMM/`:** `regime_metrics_table.csv`, `fig_state_paths.png`,
...
DATA = ROOT / 'data'
OUT  = ROOT / 'outputs' / 'HMM'; OUT.mkdir(parents=True, exist_ok=True)
...
print('\nsaved outputs/HMM/regime_metrics_table.csv\n')
...
print('saved outputs/HMM/fig_state_paths.png'); plt.show()
...
print('\nsaved outputs/HMM/table_diagnostics.csv\n')
...
print('saved outputs/HMM/final_feature_by_state.csv   (crisis state =', crisisF, ')\n')
...
print('saved outputs/HMM/final_pc_loadings.csv\n')
...
print('saved outputs/HMM/final_pc_by_state.csv   (crisis state =', crisisF, ')\n')
...
print('saved outputs/HMM/final_transition_matrix.csv   (rows sum to 1)\n')
...
print('saved outputs/HMM/fig_transition_matrix.png'); plt.show()
...
psum = postF.sum(1)
print('saved outputs/HMM/final_state_probabilities.csv')
